...
export default function Footer() {
  return (
   ...
   <h1>BOYNER DYNAMIC FEST İNTERNET SİTESİ KULLANIM KOŞULLARI</h1>
    ...
    <p>8.2. Ziyaretçi, Boyner’in veya grup şirketlerinin mülkiyetine tabi fikri mülkiyet haklarını Boyner’in izni olmaksızın kullanamaz, paylaşamaz, dağıtamaz, sergileyemez, çoğaltamaz veya bunlardan türemiş çalışmalar yapamaz. Ayrıca, Ziyaretçi, İnternet Sitesi’ni kullanarak veya İnternet Sitesi’ne yüklediği her türlü içerik, görsel ve/veya veriyi paylaşarak, Boyner’e süresiz, münhasır, alt lisanslı, geri alınamaz, dünya çapında ve tüm mülkiyet hakları ile her türlü hukuki düzenleme ve mevzuata uygun bir şekilde ve Boyner tarafından istediği türde, ortamda, hukuki yollardan ve zamanda kullanma, paylaşma ve sınırlama yetkisi verdiğini kabul eder.</p>

    <h2>MADDE 9: Uygulanacak Hukuk ve Yetkili Mahkeme</h2>

    <p>9.1. Bu Kullanım Koşulları’nın uygulanmasında ve yorumlanmasında Türkiye Cumhuriyeti kanunlarına tabi olunacaktır. Bu Kullanım Koşulları’ndan kaynaklanan her türlü uyuşmazlıkların çözümünde İstanbul (Çağlayan) Mahkemeleri ve İcra Daireleri yetkilidir.</p>
